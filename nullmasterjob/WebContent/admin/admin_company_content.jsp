...
<body>
	...
	<div class="container">
		...
		<div class="col-md-1">
		<img class="headimage" src="/taewoo2/resources/company/<%=cvo.getLogo() %>">
		</div>
		<h3><%=cvo.getName() %></h3>
	</div>
	</div>
	...
	<div class="container">
		<div class="row" align="center">
		<div class="col-md-10">
		<h1><img src="/taewoo2/resources/company/<%=cvo.getImg() %>" style="width: 100%; height: 80%"/></h1>
		</div>
		</div>
		</div>
		<br>
	...
	%>	
		<div class="col-md-4">
				<a href="/taewoo2/recruit/contentRecruit.jsp?recruit_code=<%=vo.getRecruit_code()%>">
				<img src="/taewoo2/resources/recruit/<%=vo.getImg()%>" style="width: 100%; height: 70%"></a>
				<a class="btn btn-default" href="/taewoo2/recruit/contentRecruit.jsp?recruit_code=<%=vo.getRecruit_code() %>">
				<h6><%=vo.getSubject()%></h6>
				</a>
	</div>
	<%	}
